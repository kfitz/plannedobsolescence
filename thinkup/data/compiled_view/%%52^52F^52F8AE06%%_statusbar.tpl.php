<?php /* Smarty version 2.6.26, created on 2014-10-18 14:36:16
         compiled from _statusbar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlencode', '_statusbar.tpl', 15, false),array('modifier', 'ucwords', '_statusbar.tpl', 21, false),array('modifier', 'count', '_statusbar.tpl', 104, false),array('modifier', 'capitalize', '_statusbar.tpl', 110, false),array('modifier', 'relative_datetime', '_statusbar.tpl', 119, false),)), $this); ?>
<?php if ($this->_tpl_vars['enable_bootstrap'] == 1): ?>
...
&c=posts&q=');">
                    ...
                    <input type="text" id="search-keywords" class="search-query span4 dropdown-toggle" data-toggle="dropdown" autocomplete="off" <?php if ($_GET['q']): ?>value="<?php echo $_GET['q']; ?>
...
?>
                        <li class="lead"><a onclick="searchMe('<?php echo $this->_tpl_vars['site_root_path']; ?>
search.php?u=<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['network_username'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
&n=twitter&c=searches&k=<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['hashtag'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
&q=');" href="#"><i class="icon-twitter icon-muted icon-2x"></i> Search tweets which contain <?php echo $this->_tpl_vars['i']['hashtag']; ?>
 for <span class="searchterm"></span></a></li>
                    <?php endforeach; endif; unset($_from); ?>
                    </ul>
...
crawler/updatenow.php<?php if ($this->_tpl_vars['developer_log']): ?>?log=full<?php endif; ?>" id="refresh-data" title="Refresh data"><i class="icon-refresh"></i></a></li>
...
crawler/updatenow.php<?php if ($this->_tpl_vars['developer_log']): ?>?log=full<?php endif; ?>" class="linkbutton">Capture Data</a><?php endif; ?><?php endif; ?>
  ...
  <div class="status-bar-right text-right">
    <ul>
      <?php if (count($this->_tpl_vars['instances'])): ?> 
        <li><a href="<?php echo $this->_tpl_vars['site_root_path']; ?>
