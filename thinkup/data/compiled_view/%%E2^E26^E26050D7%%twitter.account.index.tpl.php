<?php /* Smarty version 2.6.26, created on 2013-06-06 10:35:39
         compiled from /home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.account.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'help_link', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.account.index.tpl', 3, false),array('insert', 'csrf_token', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.account.index.tpl', 46, false),)), $this); ?>
...
<table class="table">
    ...
    <tr>
        ...
        <?php if ($this->_tpl_vars['user_is_admin']): ?><th><i class="icon-refresh icon-2x icon-muted"></i></th><?php endif; ?>
...
?>
    <tr>
        <td>
            <h3 class="lead"><i class="icon-twitter icon-muted"></i>&nbsp;<a href="https://twitter.com/intent/user?screen_name=<?php echo $this->_tpl_vars['i']->network_username; ?>
...
account/?p=twitter&u=<?php echo $this->_tpl_vars['i']->network_username; ?>
&n=twitter" class="btn btn-info btnHashtag">Saved searches</a>
        </td>
        <td class="action-button">
