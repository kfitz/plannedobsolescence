<?php /* Smarty version 2.6.26, created on 2014-10-18 15:19:42
         compiled from session.login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'filter_xss', 'session.login.tpl', 26, false),array('insert', 'help_link', 'session.login.tpl', 44, false),)), $this); ?>
                ...
                <fieldset style="background-color : white; padding-top : 30px;">
                    ...
                    <div class="control-group input-prepend">
                        ...
                        <div class="controls">
                            ...
                            <input class="input-xlarge" type="email" name="email" id="email"<?php if (isset ( $this->_tpl_vars['email'] )): ?> value="<?php echo ((is_array($_tmp=$this->_tpl_vars['email'])) ? $this->_run_mod_handler('filter_xss', true, $_tmp) : smarty_modifier_filter_xss($_tmp)); ?>
"<?php endif; ?> autofocus="autofocus">
                    ...
                    <div class="form-actions">
                            ...
                            <span class="pull-right">
                                <div class="btn-group">
                                    <?php if ($this->_tpl_vars['is_registration_open']): ?><a href="<?php echo $this->_tpl_vars['site_root_path']; ?>
session/register.php" class="btn btn-mini hidden-phone">Register</a><?php else: ?><?php endif; ?>
