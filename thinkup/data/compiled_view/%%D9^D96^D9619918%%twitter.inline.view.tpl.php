<?php /* Smarty version 2.6.26, created on 2014-10-18 15:22:18
         compiled from /home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.inline.view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'help_link', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.inline.view.tpl', 3, false),array('modifier', 'urlencode', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/twitter/view/twitter.inline.view.tpl', 21, false),)), $this); ?>
<div class="section">
<div class="clearfix">
...
<?php if ($this->_tpl_vars['years_most_popular']): ?>
  <?php $_from = $this->_tpl_vars['years_most_popular']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['tid'] => $this->_tpl_vars['t']):
        $this->_foreach['foo']['iteration']++;
?>
...
dashboard.php?<?php if ($_GET['v']): ?>v=<?php echo $_GET['v']; ?>
