<?php /* Smarty version 2.6.26, created on 2013-06-06 10:22:18
         compiled from /home/plannedo/plannedobsolescence.net/thinkup/plugins/facebook/view/facebook.account.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'help_link', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/facebook/view/facebook.account.index.tpl', 5, false),array('insert', 'csrf_token', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/facebook/view/facebook.account.index.tpl', 39, false),array('modifier', 'urlencode', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/facebook/view/facebook.account.index.tpl', 27, false),array('modifier', 'substr', '/home/plannedo/plannedobsolescence.net/thinkup/plugins/facebook/view/facebook.account.index.tpl', 93, false),)), $this); ?>
...
" class="btn <?php if ($this->_tpl_vars['i']->is_public): ?>btnPriv<?php else: ?>btnPub<?php endif; ?>" value="Set <?php if ($this->_tpl_vars['i']->is_public): ?>private<?php else: ?>public<?php endif; ?>" /></span>
        </div>
        <?php if ($this->_tpl_vars['user_is_admin']): ?>
        <div class="span3">
            <span id="divactivate<?php echo $this->_tpl_vars['i']->id; ?>
"><input type="submit" name="submit" id="<?php echo $this->_tpl_vars['i']->id; ?>
" class="btn <?php if ($this->_tpl_vars['i']->is_active): ?>btnPause<?php else: ?>btnPlay<?php endif; ?>" value="<?php if ($this->_tpl_vars['i']->is_active): ?>Pause<?php else: ?>Start<?php endif; ?> crawling" /></span>
        </div>
        <?php endif; ?>
        <div class="span3">
...
" value="Set <?php if ($this->_tpl_vars['i']->is_public): ?>private<?php else: ?>public<?php endif; ?>" /></span>
        </div>
        <?php if ($this->_tpl_vars['user_is_admin']): ?>
        <div class="span3">
            <span id="divactivate<?php echo $this->_tpl_vars['i']->id; ?>
...
" value="<?php if ($this->_tpl_vars['i']->is_active): ?>Pause<?php else: ?>Start<?php endif; ?> crawling" /></span>
        </div>
        <?php endif; ?>
        <div class="span3">
            <span id="delete<?php echo $this->_tpl_vars['i']->id; ?>
...
<li>
    ...
    <strong>App Display Name:</strong> <span style="font-family:Courier;"><?php echo $this->_tpl_vars['logged_in_user']; ?>
 ThinkUp</span><br />
