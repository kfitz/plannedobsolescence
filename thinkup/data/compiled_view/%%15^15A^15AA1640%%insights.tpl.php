...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'relative_day', 'insights.tpl', 32, false),array('modifier', 'relative_datetime', 'insights.tpl', 33, false),array('modifier', 'ucfirst', 'insights.tpl', 33, false),array('modifier', 'cat', 'insights.tpl', 51, false),array('modifier', 'urlencode', 'insights.tpl', 67, false),)), $this); ?>
 ...
 ago<?php endif; ?>
    ...
    <div class="span9">
        <?php if ($this->_tpl_vars['i']->filename != ''): ?>
            ...
            <!-- including <?php echo $this->_tpl_vars['tpl_filename']; ?>
 -->
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
