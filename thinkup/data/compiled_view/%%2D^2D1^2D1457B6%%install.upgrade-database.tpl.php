<?php /* Smarty version 2.6.26, created on 2014-10-18 14:43:28
    ...
    <!-- no upgrade needed -->
     <div class="alert helpful" style="margin: 20px 0px; padding: 0.5em 0.7em;">
         <p>
           ...
           Sweet! Your database is up to date. <?php if ($this->_tpl_vars['thinkup_db_version']): ?>Here's <a href="http://thinkup.com/docs/changelog/<?php echo $this->_tpl_vars['thinkup_db_version']; ?>
...
install/backup.php">back up your current ThinkUp database</a>.<?php else: ?><br />If you haven't already, <a href="http://thinkup.com/docs/install/backup.html">back up your current installation's data first</a>.<?php endif; ?>
        </p>
        </div>
