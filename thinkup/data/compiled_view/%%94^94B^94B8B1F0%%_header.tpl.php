...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucwords', '_header.tpl', 162, false),array('modifier', 'strip_tags', '_header.tpl', 163, false),)), $this); ?>
<!DOCTYPE html>
...
';
    <?php if ($this->_tpl_vars['logged_in_user']): ?>
    var owner_email = '<?php echo $this->_tpl_vars['logged_in_user']; ?>
';
    <?php endif; ?>
    <?php if ($this->_tpl_vars['thinkup_api_key']): ?>
    var thinkup_api_key = '<?php echo $this->_tpl_vars['thinkup_api_key']; ?>
';
    <?php endif; ?>
</script>


<?php if ($this->_tpl_vars['enable_tabs'] == 1): ?>
<script type="text/javascript">
    <?php echo '
      $(function() {
        // Hide all sections
