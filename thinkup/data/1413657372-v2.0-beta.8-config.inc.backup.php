...
$THINKUP_CFG['source_root_path']          = '/home/plannedo/plannedobsolescence.net/';
...
$THINKUP_CFG['db_host']                   = 'db.plannedobsolescence.net'; //On a shared host? Try mysql.yourdomain.com, or see your web host's documentation.
$THINKUP_CFG['db_type']                   = 'mysql';
$THINKUP_CFG['db_user']                   = 'thinkup_po';
$THINKUP_CFG['db_password']               = '3AqRosogPi9N';
$THINKUP_CFG['db_name']                   = 'thinkup_po';
...
if ((isset($_SESSION["MODE"]) && $_SESSION["MODE"] == "TESTS") || getenv("MODE")=="TESTS") {
    $THINKUP_CFG['db_user']                   = 'thinkup_po';
    $THINKUP_CFG['db_password']               = '3AqRosogPi9N';
    $THINKUP_CFG['db_name']                   = 'thinkup_po'; //by default, thinkup_tests
