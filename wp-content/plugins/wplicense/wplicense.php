...
<a rel="license" href="${license_uri}"><img src="${license_img}" alt="${license_name}" style="float:left; padding-right:10px;"/></a>
END_OF_STMT;
  	} else {
     	$image_html = '';
  	}
...
$image_html This work ${attrib} is licensed under a <a rel="license" href="${license_uri}">${license_name}</a> license.
...
<script type="text/javascript" src="http://api.creativecommons.org/jswidget/tags/0.97/complete.js?${jswidget_extra}">
</script>
...
function cc_addAdminPage() {
	if (function_exists('add_options_page')) {
		add_options_page('Content License', '<img src="'. WP_PLUGIN_URL . '/wplicense/images/cc_admin.png" style="padding-right: 3px; position: relative; top: 2px;">Content License', 5, basename(__FILE__), 'license_options');
		}
} // addAdminPage
